...
// import 'screens/main_navigation_page.dart'; //Página del Main Navigation donde se organizan las páginas
...
void main() async {
  ...
  await initializeDateFormatting('es_ES', null); // Activa fechas en español
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Xpnse', // Título de la aplicación
      ...
      // La pantalla inicial de la aplicación el Main Navigation Bar
