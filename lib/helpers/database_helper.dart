...
class DatabaseHelper {
  ...
  Future<int> updateExpense(Expense expense) async {
    final db = await database;
    //if (expense.categoryId == null) { throw ArgumentError("Cannot update expense: categoryId is null.");  }
    try {
      return await db.update(
        _expensesTable,
        expense.toMap(),
  ...
  //Metodo para mostrar TOP 3 de gastos de categorias

  Future<List<Map<String, dynamic>>> getTop3CategoriesByExpense() async {
    final db = await database;
    const query = '''
